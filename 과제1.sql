...
-- EMP 테이블로 부터 '85'년도에 입사한 직원 조회
SELECT *
FROM EMP
WHERE SUBSTR(HIREDATE,1,2)=85;
...
-- 입사 일로부터 30년 되는 날짜 조회
SELECT ADD_MONTHS(HIREDATE,360)
FROM EMP;

-- 입사 일로부터 37년 이상 근무한 직원의 정보 조회
SELECT *
FROM EMP
WHERE MONTHS_BETWEEN(SYSDATE,HIREDATE)>12*37;
